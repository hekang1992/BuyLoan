...
class PLAPersonalViewController: BaseViewController {
...
extension PLAPersonalViewController {
    ...
    func getPersonDate() {
        ViewHud.addLoadView()
        wangluoManager.shared.requestAPI(params: ["trapesing": productID ?? ""], pageUrl: "/cll/ghostPencil", method: .post) { [weak self] successModel in
    ...
    func savePInfo() {
        ...
        ViewHud.addLoadView()
        wangluoManager.shared.requestAPI(params: dict, pageUrl: "/cll/collectorTeeth", method: .post) { [weak self] successModel in
